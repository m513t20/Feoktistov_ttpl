import { CowCompiler } from '../src/compiler';
...
describe('CowCompiler - Полное покрытие', () => {
  ...
  describe('MoO - значение текущей ячейки увеличить на 1', () => {
    test('MoO', () => {
      const compiler = new CowCompiler("MoO");
      compiler.interpret();
  ...
  describe('MOo + MoO', () => {
    test('MOo + MoO', () => {
      const compiler = new CowCompiler("MOo MoO");
      compiler.interpret();
  ...
  describe('OOM - вывод значения текущей ячейки', () => {
    test('OOM', () => {
      const compiler = new CowCompiler("MoO MoO OOM");
      compiler.interpret();
  ...
  describe('oom - ввод значения в текущую ячейку', () => {
    test('oom', () => {
      const compiler = new CowCompiler("oom", "a");
      compiler.interpret();
  ...
  describe('Moo - если значение в ячейке равно 0, то ввести с клавиатуры, если значение не 0, то вывести на экран', () => {
    test('Moo', () => {
      const compiler = new CowCompiler("MoO MoO Moo");
      compiler.interpret();
      expect(compiler.output.charAt(0)).toBe(String.fromCharCode(2));

      const compiler2 = new CowCompiler("Moo");
      (global as any).prompt = jest.fn(() => '1');
  ...
  describe('OOO - обнулить значение в ячейке', () => {
    test('OOO', () => {
      const compiler = new CowCompiler("MoO MoO OOO");
      compiler.interpret();
  ...
  describe('OOO - обнулить значение в ячейке', () => {
    test('OOO', () => {
      const compiler = new CowCompiler("MoO MoO MMM moO MMM");
      compiler.interpret();
  ...
  describe('Базовые операции памяти', () => {
    test('hello world', () => {
      const compiler = new CowCompiler(helloWorld);
      compiler.interpret();
  ...
  describe('фибоначи', () => {
    test('фибоначи', () => {
      const compiler = new CowCompiler(fibbonachi);
      compiler.interpret();
